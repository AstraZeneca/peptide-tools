...
#python ../rdkit_pI.py -i ${i} --plot_titration_curve --print_fragment_pkas --use_acdlabs
#python ../rdkit_pI.py -i ${i} --plot_titration_curve --print_fragment_pkas --use_dimorphite --json  &> $o

python /projects/cc/kzjv133/sync/Distr/peptide_tools_GitHub/rdkit_pI/rdkit_pI.py -i ${i} --plot_titration_curve --print_fragment_pkas --use_pkamatcher  &> $o
#python ../rdkit_pI.py -i ${i} --plot_titration_curve --print_fragment_pkas --use_pkamatcher
