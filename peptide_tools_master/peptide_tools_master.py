...
def arg_parser():
    ...
    parser.add_argument(
        "--input",
        dest="input",
        help="input of a molecule structure: Smiles, fasta, database ID, filename (smi, sdf, fasta)",
        default="",
        required=True,
    )
    ...
    parser.add_argument(
        ...
        default="no",
        action="store",
        dest="l_print_pka_set",
        help="Print out stored pka sets explicitly.",
    )
    ...
    if args.l_print_pka_set == "yes":
        args.l_print_pka_set = True
    else:
        args.l_print_pka_set = False

    if args.l_print_fragment_pkas == "yes":
        args.l_print_fragment_pkas = True
    else:
