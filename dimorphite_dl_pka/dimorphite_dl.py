...
#
# NOTICE: file chaged by Andrey Frolov 2021-08-16. The function 
# "get_protonation_sites" of class "Protonate" modified such that it 
# outputs the names of the matched sites. These are later used in rdkit_pI.py
# to get the corresponding pKa values from the data table.
#
...
### NOTICE. The following code modified from the original distribution of Dimorphite-DL. AIF
    def get_protonation_sites(self):
        """Return the next protonation sites
